...
<head>
	...
	<script src="images/images/https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
	...
	<div id="wrapper">
		...
		<div id="Home" class="w3-container w3-mobile">
			...
			<div id="second" class="w3-container ">
				<div class="w3-col s4">
					<img class="w3-display w3-mobile w3-margin-bottom" src="images/Emblem_of_India.svg" style="width:50%">
				</div>
				<div class="w3-col s4">
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="images/home1.jpg" style="width:100%">
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="images/home2.jpg" style="width:100%">
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="images/incredible3.jpg" style="width:100%">
					<img class="mySlides w3-middle w3-animate-fading w3-mobile w3-row-padding w3-margin-top w3-margin-top w3-mobile" src="images/incredible7.jpg" style="width:100%">
				</div>
				
				<div class="w3-col s4 ">
					<img class="w3-right w3-display w3-mobile w3-margin-bottom w3-margin-left" src="images/Emblem_of_India.svg" style="width:50%">
				</div>
				<script>
				var myIndex = 0;
				carousel();
			...
			<nav class="navbar navbar-inverse w3-opacity-min w3-top w3-mobile" data-spy="affix" data-offset-top="197">
				<div class="container-fluid w3-xlarge w3-black">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.php"><img class="w3-ripple w3-margin-right w3-mobile w3-hover-none w3-hover-text-white" src="images/Logo.jpg"></a>
					</div>
		...
		<section id="Unexplored">
			...
			<div class="w3-row-padding w3-margin-top w3-margin-bottom">
			  <div class="w3-third">
				<div class="w3-card-2 w3-display-container w3-hover-opacity">
					<div class="post">
						...
						<img class="w3-mobile" src="images/Chembra-Lake-in-Meppadi.jpg" alt="Chembra" style="width:100%">
						</a>
			  ...
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity w3-display-container">
					...
					<img class="w3-mobile" src="images/Parule-Bhogwe-in-Maharashtra.jpg" style="width:100%" alt="Parule">
					</a>
			  ...
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity post">
				  ...
				  <img class="w3-mobile" src="images/Damro-in-Arunachal-Pradesh.jpg" style="width:100%" alt="Damro">
				  </a>
				  <div class="w3-container">
					<h5>Damro</h5>
				  </div>
			...
			<div class="post w3-animate-bottom w3-margin w3-card-4 ">
				<div id="Chembra" class="post picture w3-display-container" style="display:none">
				  <a href="review.php?id=56"><img class="w3-mobile" src="images/Chembra-Lake-in-Meppadi.jpg" alt="Chembra" style="width:100%"></a>
				...
				<div id="Parule" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=1"><img class="w3-mobile" src="images/Parule-Bhogwe-in-Maharashtra.jpg" alt="Parule" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Gurez" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=58"><img class="w3-mobile" src="images/Gurez-Valley-in-Kashmir-2.jpg" alt="Gurez" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Lepakshi" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=57"><img class="w3-mobile" src="images/Lepakshi-in-Andhra-Pradesh2.jpg" alt="Lepakshi" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Damro" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=2"><img class="w3-mobile" src="images/Damro-in-Arunachal-Pradesh.jpg" alt="Damro" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
				...
				<div id="Chopta" class="picture w3-display-container" style="display:none">
				  <a href="review.php?id=59"><img class="w3-mobile" src="images/Chopta-in-Uttarakhand.jpg" alt="Chopta" style="width:100%"></a>
				  <span onclick="this.parentElement.style.display='none'" 
				  class="w3-display-topright w3-button w3-transparent w3-text-white">&times;</span>
			...
			<div class="w3-row-padding w3-margin-top">
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity post">
				  ...
				  <img class="w3-mobile" src="images/Lepakshi-in-Andhra-Pradesh2.jpg" style="width:100%" alt="Lepakshi">
				  </a>
				  <div class="w3-container">
					<h5>Lepakshi</h5>
				  </div>
			  ...
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity post w3-btn">
				  ...
				  <img class="w3-mobile" src="images/Gurez-Valley-in-Kashmir-2.jpg" style="width:100%" alt="Gurez">
				  </a>
				  <div class="w3-container">
					<h5>Gurez-Valley</h5>
				  </div>
			  ...
			  <div class="w3-third">
				<div class="w3-card-2 w3-hover-opacity post">
				  ...
				  <img class="w3-mobile" src="images/Chopta-in-Uttarakhand.jpg" style="width:100%" alt="Chopta">
				  </a>
				  <div class="w3-container">
					<h5>Chopta</h5>
				  </div>
		...
		<div id="Reach" class="container w3-mobile">
			<div class="w3-row-padding w3-margin-top w3-mobile">
					<div class="w3-col s6 w3-left"><img class="w3-mobile" src="images/images/images/logo1.jpg" alt="MP Tourism Logo"></div>
